...
def Convert_To_Data_Type(data_type: str) -> tuple[str, str]:
...
def Create_New_Tag(name_parts: List[str], device_name:str, orignal_tag_name:str, area: str, path_data_type: str, array_size: str, offset: str, data_type: str, tags: Dict[str, Any], is_tag_from_csv_flag: bool, current_tag) -> Dict[str, Any]:
    if array_size != '':
        data_type = 'String'
    full_path = ''
...
def Process_Tag_Name(ignition_json: Dict[str, Any], key: str, tag_name: str, area: str, path_data_type: str, data_type: str, tags: Dict[str, Any], array_size: str, offset: str, is_tag_from_csv_flag=False) -> None:
    if '.' in tag_name:
        ...
        orignal_tag_name = tag_name
        name_parts = [tag_name]
        current_tags = ignition_json[key]['tags']
    
    
    new_tag = Create_New_Tag(name_parts, ignition_json[key]['name'], orignal_tag_name, area, path_data_type, array_size, offset, data_type, ignition_json[key]['tags'], is_tag_from_csv_flag, tags)
            ...
            for tags in ignition_json[key]['tags']:
                if 'opcItemPath' in tags:
                    ...
                    if 'dataType' in tags:
                        ...
                        path_data_type, data_type = Convert_To_Data_Type(data_type)
                        ...
                        if not row.empty:
                            ...
                            array_size, offset = Convert_Array_Size_To_Mitsubishi_Format(offset, path_data_type)
                            if data_type == "":
                                data_type = tags['dataType']
                            if '.' in tag_name:
